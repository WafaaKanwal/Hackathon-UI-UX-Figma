...
const HeaderBar: React.FC = () => {
  return (
    <div className="bg-[#7E33E0] w-full h-auto py-2 sm:h-11 flex flex-col sm:flex-row items-center justify-between px-4 sm:px-10 md:px-14 lg:px-24 xl:px-[13rem] 2xl:px-[18rem] text-white text-[10px] xs:text-[8px] md:text-[10px] lg:text-[12px] leading-[16px] lg:font-medium">
      {/* Left Section */}
      <div className="flex xs:gap-4 sm:gap-0 sm:flex-row items-center sm:space-x-4 md:space-x-8 lg:space-x-11 mb-1 sm:mb-0 xs:mr-1 sm:mr-0">
        <div className="flex items-center space-x-2 hover:text-[#FB2E86] mb-2 sm:mb-0">
          ...
          <Link href="/faq"><span className="cursor-pointer">mhhasanul@gmail.com</span></Link>
        </div>
        <div className="flex items-center space-x-2 xs:mb-2 sm:mb-0 hover:text-[#FB2E86]">
          <span className="material-icons">
            <svg
              width="16"
              height="16"
          ...
          <Link href="/about"><span className="cursor-pointer">(12345)67890</span></Link> 
        </div>
      </div>

      {/* Right Section */}
      <div className="flex items-center space-x-2 sm:space-x-4 md:space-x-6">
        <div className="flex items-center space-x-1 cursor-pointer hover:text-[#FB2E86]">
          <span>English</span>
          <span className="material-icons">
            <svg
              width="12"
